...
extension Recipe {
    static let all: [Recipe] = [
            ...
            Recipe(name: "Cremy Carrot Soup",
                   ...
                   description:"This bold-hued soup is perfectly sweet and seriously comforting. Peeling the red bell pepper helps make this carrot soup extra silky. Dress it up with a drizzle of rich cashew cream, pomegrenate seeds, and chopped fresh parsley for a festive autumn presentation.",
            ...
            Recipe(name: "Kale, Apple, and Quinoa Salad",
                   image:"https://www.forksoverknives.com/uploads/Kale-Apple-Quinoa-Salad-wordpress.jpg?auto=webp&auto=webp&optimize=high&quality=70&width=367&dpr=2",
                   description: "Each bite of this colourful salad is filled with the flavours of favourite autumn ingredients such as apples, butternut squash, and pumpkin seeds. For optimum freshness and texture, wait to add the dressing until just before serving. \n\nNote that this recipe calls for cooked quinoa, so have that ready to go: For 1½ cups cooked quinoa, rinse and drain ½ cup quinoa; cook according to package directions; and drain if needed. Check out our Grains Cooking Guide for more tips on prepping grains like a pro.",
                   ...
                   directions: "Preheat oven to 400°F. Line a 15×10-inch baking pan with parchment paper or a silicone baking mat. Arrange squash in the prepared baking pan. Roast 20 to 25 minutes or until squash is tender, brushing lightly with water if squash starts to look dry. Cool slightly on a wire rack.\nMeanwhile, in a small bowl toss together pumpkin seeds and ½ teaspoon water; sprinkle with cinnamon. Place pumpkin seeds in a small, shallow baking pan. Roast 5 minutes or until lightly toasted; cool.\nFor dressing, remove 1 teaspoon zest and squeeze 2 tablespoons juice from lemon.\nIn a small bowl whisk together lemon zest and juice, maple syrup, and mustard. In a large bowl combine kale, quinoa, apple, green onions, and roasted squash. Add dressing; toss to coat. Season with salt and pepper. Top with pumpkin seeds.",
                   category: "Salad",
                   datePublished: "2019-10-22",
                   url: "https://www.forksoverknives.com/recipes/vegan-salads-sides/kale-apple-and-quinoa-salad/"),
            Recipe(name: "Kale Bruschetta",
                   image: "https://www.forksoverknives.com/uploads/Kale-Bruschetta-WP.jpg?auto=webp&auto=webp&optimize=high&quality=70&width=367&dpr=2",
                   description: "We adore this as a starter, and so does everyone else. It is always the first empty platter at our holiday party. No one knows it is plant-based; they just know it is so yummy.\nFrom The Prevent and Reverse Heart Disease Cookbook This kale bruschetta recipe is also available in our convenient iPhone app and newly released Android app.",
                   ingredients: "1 bunch kale\n1 loaf fresh 100% whole-grain bread, sliced ½ cup Cannellini Bean Sauce\n1 cup grape tomatoes, halved\nbalsamic glaze",
            ...
            Recipe(name: "Vegetable Pot Pie",
                   image: "https://www.forksoverknives.com/uploads/Vegetable-pot-pie-for-wordpress.jpg?auto=webp&auto=webp&optimize=high&quality=70&width=367&dpr=2",
            ...
            Recipe(name: "Red Lentil Loaf with Smoky tomato Sauce Recipe",
                   image: "https://www.forksoverknives.com/uploads/Red-Lentil-Loaf.jpg?auto=webp&auto=webp&optimize=high&quality=70&width=367&dpr=2",
            ...
            Recipe(name: "Roasted Root Vegetable Medley",
                   image: "https://www.forksoverknives.com/uploads/Roasted-Root-Vegetable-Medley-wordpress.jpg?auto=webp&auto=webp&optimize=high&quality=70&width=367&dpr=2",
            ...
            Recipe(name: "Raspberry Truffle Brownies",
                   image: "https://www.forksoverknives.com/uploads/Raspberry-Brownies-300kb.jpg?auto=webp&auto=webp&optimize=high&quality=70&width=367&dpr=2",
